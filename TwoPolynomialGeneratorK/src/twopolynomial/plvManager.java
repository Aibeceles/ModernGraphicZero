...
public class plvManager extends Thread{
    ...
    BigDecimal NN;    //= new BigDecimal(100);                                      //  must be set in agreement with plvRunThread arguments
    BigDecimal lower;
    BigDecimal range;
  ...
  public  plvManager(Semaphore tlSemaphore,Semaphore t2Semaphore,Semaphore cosetSemaphore,vertexVector dbVector,
                     vertexVector db1Vector,vertexVector db2Vector,Semaphore tl1Semaphore,vertexVector dbVector11,BigDecimal upper,BigDecimal lower,BigDecimal range){
       tlSem=tlSemaphore;
       t2Sem=t2Semaphore;
    ...
    public void run(){
     ...
     plvRunThread mage = new plvRunThread(this.range.intValue(),this.lower.intValue(),this.NN.intValue(),NN,tlSem,t2Sem,cosetSem,dbbVector,dbb1Vector,dbbCSTVector,tl1Sem,dbbVector11);
//     NN=NN.add(increment);
