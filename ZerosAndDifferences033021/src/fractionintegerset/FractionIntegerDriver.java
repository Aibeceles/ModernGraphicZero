 ...
 * @author Aibes
 */
public class FractionIntegerDriver extends Thread implements GBIterator{
...
int denominator=11;                                                    // needs to be set through constructor
int numeratorLow=1;
int numeratorHigh=11;
...
public FractionIntegerDriver(List muList,Semaphore muSem) {
   this.muList=muList;
   this.muSem=muSem;        
}
