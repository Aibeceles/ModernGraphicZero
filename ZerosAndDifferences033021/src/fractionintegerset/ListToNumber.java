...
System.out.println("ListToNumber.getIntegerFromList.nList: "+ nList.toString());
System.out.println("ListToNumber.getIntegerFromList.resultInt: "+ resultInt.toString());
return(resultInt);
}    
