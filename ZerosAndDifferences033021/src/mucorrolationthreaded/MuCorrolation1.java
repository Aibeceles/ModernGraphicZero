 ...
 * @author Aibes
 */
public class MuCorrolation1 extends Thread{
    ...
    */
    ...
    FractionIntegerDriver fig= null;
 //   GBIterator fig = (GBIterator) new Thread();
    
    public MuCorrolation1(Semaphore t1Sem, List rootLi,FractionIntegerDriver fig, List muList,Semaphore muSem) {
    tiSemap=t1Sem;
    rootLis=rootLi;        
    this.fig=fig;
    this.muList=muList;
 ...
 //   public MuCorrolation1(Semaphore t1Sem, List rootLi,FractionIntegerDriverIterate fig, List muList,Semaphore muSem) {
  //  tiSemap=t1Sem;
  //  rootLis=rootLi;        
  //  this.fig=fig;
  //  this.muList=muList;
 ...
 //           Logger.getLogger(MuCorrolation1.class.getName()).log(Level.SEVERE, null, ex);
 //       }
    System.out.println("                       MuCorrolation1    " );
     muListObjectNum=0;
   ...
   //  while (muListObjectNum<maxMu) {
      ...
      System.out.println("  fig.isAlive())  " + muDecimal.toString());
