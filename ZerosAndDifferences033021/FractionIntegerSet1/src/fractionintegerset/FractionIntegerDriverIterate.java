...
public void run() {
   ...
   rListB.add(gbList);
   Callable workerZero = new GenerateBinaryZeroIterate(numeratorLow,denominator,(Semaphore)semaphoreListF.get(0),(Semaphore)semaphoreListF.get(semaphoreListSizeF-2),(Semaphore)semaphoreListB.get(semaphoreListSizeB-2),(Semaphore)semaphoreListF.get(semaphoreListSizeF-3),(Semaphore)semaphoreListB.get(semaphoreListSizeB-3),endProduct,gbList,rListB); 
  ...
  for (int numerator=numeratorLow+1; numerator<numeratorHigh ; numerator++) {
          ...
          rListB.add(gbList1);
          Callable worker = new GenerateBinaryIterate(numerator,denominator,(Semaphore)semaphoreListF.get(semaphoreListSizeF-2),(Semaphore)semaphoreListB.get(semaphoreListSizeB-2),(Semaphore)semaphoreListF.get(semaphoreListSizeF-3),(Semaphore)semaphoreListB.get(semaphoreListSizeB-3),endProduct,gbList1); 
   ...
   rListB.add(gbList2);
   Callable workerLast = new GenerateBinaryLastIterate(numeratorHigh,denominator,(Semaphore)semaphoreListF.get(semaphoreListSizeF-2),(Semaphore)semaphoreListB.get(semaphoreListSizeB-2),(Semaphore)semaphoreListF.get(semaphoreListSizeF-3),(Semaphore)semaphoreListB.get(semaphoreListSizeB-3),endProduct,gbList2); 
